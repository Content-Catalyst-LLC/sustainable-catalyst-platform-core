...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app.include_router(hypothesis_intelligence.router)
    app.include_router(hypothesis_intelligence.public_router)
    ...
    app.include_router(unified_research_runtime.router)
    app.include_router(unified_research_runtime.public_router)
    ...
    # v3.1.0 runtime-neutral Analytical Runtime Provider Contract.
    app.include_router(analytical_runtime_provider.router)
    app.include_router(analytical_runtime_provider.public_router)
    # v3.2.0 Analytical Result & Provenance Integration.
    app.include_router(analytical_result_provenance.router)
    app.include_router(analytical_result_provenance.public_router)
    ...
    # v3.24.0 Execution Environment & Dependency Provenance.
    app.include_router(execution_environment_provenance.router)
    app.include_router(execution_environment_provenance.public_router)
    ...
    # v3.29.0 Inference Run & AI Artifact Provenance.
    app.include_router(ai_inference_provenance.router)
    app.include_router(ai_inference_provenance.public_router)
    ...
    # v3.33.0 AI Error Analysis, Robustness & Failure Taxonomy.
    app.include_router(ai_error_robustness.router)
    app.include_router(ai_error_robustness.public_router)
    ...
    # v3.42.0 Verification & Reproduction Engine.
    app.include_router(verification_reproduction.router)
    app.include_router(verification_reproduction.public_router)
    # v3.43.0 Runtime Security, Isolation & Governance.
    app.include_router(runtime_security.router)
    app.include_router(runtime_security.public_router)
    ...
    # v3.50.0 Fortran Runtime.
    app.include_router(fortran_runtime.router)
    app.include_router(fortran_runtime.public_router)
    # v3.51.0 C/C++ Runtime.
    app.include_router(c_cpp_runtime.router)
    app.include_router(c_cpp_runtime.public_router)
