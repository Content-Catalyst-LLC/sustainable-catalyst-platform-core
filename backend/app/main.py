...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    # Predictive Intelligence begins with v2.52.0 model identity and forecast provenance.
