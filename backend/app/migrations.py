...
MIGRATIONS = [
    ...
    ("0060", 'Anomaly, change-point, and early-warning intelligence with governed monitoring studies, detection rules, external anomaly/change/signal evidence, monitoring episodes, and reproducible packages without Core-side detection, threshold optimization, alert dispatch, causal attribution, or intervention.'),
]
