...
MIGRATIONS = [
    ...
    ("0041", "Causal Systems Explorer with governed causal graphs, typed variables and directed relationships, interventions, explicit identification records, externally attributable causal estimates and diagnostics, deterministic DAG/path reasoning, conservative adjustment-set candidates, and Lab/Workbench estimation handoffs."),
]
