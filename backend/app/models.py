...
class EntityAlias(Base):
    ...
    __table_args__ = (
        UniqueConstraint("namespace", "value", name="uq_alias_namespace_value"),
...
class EvidenceFoundation(Base):
    ...
    __table_args__ = (
        Index("ix_evidence_subject", "subject_entity_id"),
...
class ValidationEvent(Base):
    ...
    __table_args__ = (
        Index("ix_validation_component_status", "component", "status"),
        Index("ix_validation_entity", "entity_id"),
        Index("ix_validation_observed", "observed_at"),
    )
