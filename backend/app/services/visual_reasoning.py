    ...
    return {
        **state,
        ...
        "renderer_contract": {
            ...
            "visualization_specification_layer": "v2.35.0 System Maps + Flow Maps + Scenario Landscapes + Interactive Model Canvas + Scenario Compute Engine on v2.30 Visualization Specification & Renderer Registry",
