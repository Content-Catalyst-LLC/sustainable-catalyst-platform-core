...
REFERENCE_GO_RUNTIME = "sc-runtime-go"
REFERENCE_GO_VERSION = "1.0.0"
REFERENCE_GO_ADAPTER = "adapter:sc-runtime-go"
REFERENCE_PYTHON_RUNTIME = "sc-runtime-python"
REFERENCE_PYTHON_VERSION = "1.0.0"
REFERENCE_PYTHON_ADAPTER = "adapter:sc-runtime-python"
REFERENCE_PROLOG_RUNTIME = "sc-runtime-prolog"
REFERENCE_PROLOG_VERSION = "1.0.0"
REFERENCE_PROLOG_ADAPTER = "adapter:sc-runtime-prolog"
REFERENCE_JVM_RUNTIME = "sc-runtime-jvm"
REFERENCE_JVM_VERSION = "1.0.0"
REFERENCE_JVM_ADAPTER = "adapter:sc-runtime-jvm"
...
class RuntimeCapability(str, Enum):
    ...
    concurrent_distributed = "concurrent-distributed"
    parallel_compute = "parallel-compute"
    batch_processing = "batch-processing"
    general_scientific = "general-scientific"
    data_analysis = "data-analysis"
    reproducible_randomness = "reproducible-randomness"
    text_analysis = "text-analysis"
    logic_constraint_reasoning = "logic-constraint-reasoning"
    contradiction_analysis = "contradiction-analysis"
    temporal_reasoning = "temporal-reasoning"
    constraint_solving = "constraint-solving"
    managed_vm_execution = "managed-vm-execution"
...
def reference_runtime_catalog() -> UnifiedRuntimeCatalog:
    return UnifiedRuntimeCatalog(
        ...
        entries=[
            ...
            UnifiedRuntimeCatalogEntry(catalog_entry_id="runtime-catalog-entry:sc-runtime-go:1.0.0",runtime_ref=REFERENCE_GO_RUNTIME,runtime_version=REFERENCE_GO_VERSION,runtime_adapter_ref=REFERENCE_GO_ADAPTER,language="Go",capabilities=[RuntimeCapability.concurrent_distributed,RuntimeCapability.parallel_compute,RuntimeCapability.batch_processing,RuntimeCapability.graph_processing,RuntimeCapability.deterministic_hashing,RuntimeCapability.workflow_execution,RuntimeCapability.reproduction,RuntimeCapability.verification],operations=["parallel_sum","parallel_map_affine","concurrent_histogram","parallel_matrix_row_sums","parallel_graph_degrees","batch_sha256"],readable_formats=["json"],writable_formats=["json","txt"],environment_package_ref="environment-package:go-runtime:v1",security_policy_ref="runtime-security-policy:go-runtime-standard:v1",isolation_profile_ref="isolation-profile:go-runtime-standard:v1",metadata={"provider_contract":"sc.core.go-runtime.v1","native_runtime":"Go","native_runtime_version":"1.22.2","native_package_version":"1.22.2-2ubuntu0.4","external_module_downloads":False,"cgo":False}),
            UnifiedRuntimeCatalogEntry(catalog_entry_id="runtime-catalog-entry:sc-runtime-python:1.0.0",runtime_ref=REFERENCE_PYTHON_RUNTIME,runtime_version=REFERENCE_PYTHON_VERSION,runtime_adapter_ref=REFERENCE_PYTHON_ADAPTER,language="Python",capabilities=[RuntimeCapability.general_scientific,RuntimeCapability.data_analysis,RuntimeCapability.descriptive_statistics,RuntimeCapability.regression,RuntimeCapability.matrix_compute,RuntimeCapability.reproducible_randomness,RuntimeCapability.text_analysis,RuntimeCapability.workflow_execution,RuntimeCapability.reproduction,RuntimeCapability.verification],operations=["descriptive_summary","linear_regression","matrix_multiply","standardize","bootstrap_mean_ci","token_frequency"],readable_formats=["json"],writable_formats=["json","txt"],environment_package_ref="environment-package:python-runtime:v1",security_policy_ref="runtime-security-policy:python-runtime-standard:v1",isolation_profile_ref="isolation-profile:python-runtime-standard:v1",metadata={"provider_contract":"sc.core.python-runtime.v1","native_runtime":"CPython","native_runtime_version":"3.12.3","isolated_mode":True,"site_imports_disabled_for_jobs":True,"job_network_access":False}),
            UnifiedRuntimeCatalogEntry(catalog_entry_id="runtime-catalog-entry:sc-runtime-prolog:1.0.0",runtime_ref=REFERENCE_PROLOG_RUNTIME,runtime_version=REFERENCE_PROLOG_VERSION,runtime_adapter_ref=REFERENCE_PROLOG_ADAPTER,language="Prolog",capabilities=[RuntimeCapability.logic_constraint_reasoning,RuntimeCapability.graph_reasoning,RuntimeCapability.contradiction_analysis,RuntimeCapability.temporal_reasoning,RuntimeCapability.constraint_solving,RuntimeCapability.workflow_execution,RuntimeCapability.reproduction,RuntimeCapability.verification],operations=["relation_reachable","relation_paths_bounded","transitive_closure","contradiction_scan","temporal_consistency","graph_coloring"],readable_formats=["json"],writable_formats=["json","txt"],environment_package_ref="environment-package:prolog-runtime:v1",security_policy_ref="runtime-security-policy:prolog-runtime-standard:v1",isolation_profile_ref="isolation-profile:prolog-runtime-standard:v1",metadata={"provider_contract":"sc.core.prolog-runtime.v1","native_runtime":"SWI-Prolog","native_runtime_version":"9.0.4","native_package_version":"9.0.4+dfsg-3.1ubuntu4","provider_generated_programs":True}),
            UnifiedRuntimeCatalogEntry(catalog_entry_id="runtime-catalog-entry:sc-runtime-jvm:1.0.0",runtime_ref=REFERENCE_JVM_RUNTIME,runtime_version=REFERENCE_JVM_VERSION,runtime_adapter_ref=REFERENCE_JVM_ADAPTER,language="JVM bytecode",capabilities=[RuntimeCapability.managed_vm_execution,RuntimeCapability.parallel_compute,RuntimeCapability.graph_processing,RuntimeCapability.deterministic_hashing,RuntimeCapability.workflow_execution,RuntimeCapability.reproduction,RuntimeCapability.verification],operations=["jvm_runtime_info","parallel_sum","parallel_map_affine","matrix_row_sums","graph_bfs","batch_sha256"],readable_formats=["json"],writable_formats=["json","txt"],environment_package_ref="environment-package:jvm-runtime:v1",security_policy_ref="runtime-security-policy:jvm-runtime-standard:v1",isolation_profile_ref="isolation-profile:jvm-runtime-standard:v1",metadata={"provider_contract":"sc.core.jvm-runtime.v1","native_runtime":"OpenJDK JVM","native_runtime_version":"21","runtime_kind":"execution-target","language_profiles_deferred_to":"3.56.1","spark_adapter_deferred_to":"3.56.2"}),
        ],
        generated_from_refs=["runtime-adapter-registry:platform-core","runtime-data-interchange-bundle:reference-r-julia:v1","runtime-security-governance-bundle:reference:v1","stan-runtime-bundle:reference:v1","octave-runtime-bundle:reference:v1","gretl-hansl-runtime-bundle:reference:v1","haskell-runtime-bundle:reference:v1","fortran-runtime-bundle:reference:v1","c-cpp-runtime-bundle:reference:v1","rust-runtime-bundle:reference:v1","go-runtime-bundle:reference:v1","python-runtime-bundle:reference:v1","prolog-runtime-bundle:reference:v1","jvm-runtime-bundle:reference:v1"],
...
def reference_product_profiles() -> list[ProductRuntimeIntegrationProfile]:
    ...
    all_go_ops=["parallel_sum","parallel_map_affine","concurrent_histogram","parallel_matrix_row_sums","parallel_graph_degrees","batch_sha256"]
    all_python_ops=["descriptive_summary","linear_regression","matrix_multiply","standardize","bootstrap_mean_ci","token_frequency"]
    all_prolog_ops=["relation_reachable","relation_paths_bounded","transitive_closure","contradiction_scan","temporal_consistency","graph_coloring"]
    all_jvm_ops=["jvm_runtime_info","parallel_sum","parallel_map_affine","matrix_row_sums","graph_bfs","batch_sha256"]
    return [
        ProductRuntimeIntegrationProfile(product_profile_id="product-runtime-profile:workspace:v1",product_id=ProductId.workspace,integration_version="2.1.0",allowed_actions=[RuntimeAction.execute,RuntimeAction.statistical_analysis,RuntimeAction.workflow,RuntimeAction.interchange,RuntimeAction.reproduce,RuntimeAction.verify,RuntimeAction.inspect],allowed_runtime_refs=[REFERENCE_R_RUNTIME,REFERENCE_JULIA_RUNTIME,REFERENCE_STAN_RUNTIME,REFERENCE_OCTAVE_RUNTIME,REFERENCE_GRETL_RUNTIME,REFERENCE_HASKELL_RUNTIME,REFERENCE_FORTRAN_RUNTIME,REFERENCE_CPP_RUNTIME,REFERENCE_RUST_RUNTIME,REFERENCE_GO_RUNTIME,REFERENCE_PYTHON_RUNTIME,REFERENCE_PROLOG_RUNTIME,REFERENCE_JVM_RUNTIME],allowed_operations={REFERENCE_R_RUNTIME:all_r_ops,REFERENCE_JULIA_RUNTIME:all_julia_ops,REFERENCE_STAN_RUNTIME:all_stan_ops,REFERENCE_OCTAVE_RUNTIME:all_octave_ops,REFERENCE_GRETL_RUNTIME:all_gretl_ops,REFERENCE_HASKELL_RUNTIME:all_haskell_ops,REFERENCE_FORTRAN_RUNTIME:all_fortran_ops,REFERENCE_CPP_RUNTIME:all_cpp_ops,REFERENCE_RUST_RUNTIME:all_rust_ops,REFERENCE_GO_RUNTIME:all_go_ops,REFERENCE_PYTHON_RUNTIME:all_python_ops,REFERENCE_PROLOG_RUNTIME:all_prolog_ops,REFERENCE_JVM_RUNTIME:all_jvm_ops},required_capabilities=[RuntimeCapability.workflow_execution],default_execution_host_ref="workspace-execution-host:primary",api_scopes=["runtime:catalog","runtime:resolve","runtime:invoke","runtime:receipt","runtime:reproduce"],source_product_contract_refs=["workspace-runtime-orchestration","sc.core.stan-runtime.v1","sc.core.octave-runtime.v1","sc.core.gretl-hansl-runtime.v1","sc.core.haskell-runtime.v1","sc.core.fortran-runtime.v1","sc.core.c-cpp-runtime.v1","sc.core.rust-runtime.v1","sc.core.go-runtime.v1","sc.core.python-runtime.v1","sc.core.prolog-runtime.v1","sc.core.jvm-runtime.v1"],metadata={"role":"primary-runtime-orchestrator","rust_runtime_enabled":True,"go_runtime_enabled":True,"python_runtime_enabled":True,"prolog_runtime_enabled":True,"jvm_runtime_enabled":True}),
        ProductRuntimeIntegrationProfile(product_profile_id="product-runtime-profile:research-lab:v1",product_id=ProductId.research_lab,integration_version="2.1.0",allowed_actions=[RuntimeAction.execute,RuntimeAction.statistical_analysis,RuntimeAction.interchange,RuntimeAction.verify,RuntimeAction.inspect],allowed_runtime_refs=[REFERENCE_R_RUNTIME,REFERENCE_JULIA_RUNTIME,REFERENCE_STAN_RUNTIME,REFERENCE_OCTAVE_RUNTIME,REFERENCE_GRETL_RUNTIME,REFERENCE_HASKELL_RUNTIME,REFERENCE_FORTRAN_RUNTIME,REFERENCE_CPP_RUNTIME,REFERENCE_RUST_RUNTIME,REFERENCE_GO_RUNTIME,REFERENCE_PYTHON_RUNTIME,REFERENCE_PROLOG_RUNTIME,REFERENCE_JVM_RUNTIME],allowed_operations={REFERENCE_R_RUNTIME:all_r_ops,REFERENCE_JULIA_RUNTIME:all_julia_ops,REFERENCE_STAN_RUNTIME:all_stan_ops,REFERENCE_OCTAVE_RUNTIME:all_octave_ops,REFERENCE_GRETL_RUNTIME:all_gretl_ops,REFERENCE_HASKELL_RUNTIME:all_haskell_ops,REFERENCE_FORTRAN_RUNTIME:all_fortran_ops,REFERENCE_CPP_RUNTIME:all_cpp_ops,REFERENCE_RUST_RUNTIME:all_rust_ops,REFERENCE_GO_RUNTIME:all_go_ops,REFERENCE_PYTHON_RUNTIME:all_python_ops,REFERENCE_PROLOG_RUNTIME:all_prolog_ops,REFERENCE_JVM_RUNTIME:all_jvm_ops},required_capabilities=[RuntimeCapability.statistical_analysis,RuntimeCapability.numerical_compute,RuntimeCapability.bayesian_inference,RuntimeCapability.linear_algebra,RuntimeCapability.econometrics,RuntimeCapability.exact_arithmetic,RuntimeCapability.scientific_hpc,RuntimeCapability.native_engineering,RuntimeCapability.safe_native_systems,RuntimeCapability.concurrent_distributed,RuntimeCapability.general_scientific,RuntimeCapability.logic_constraint_reasoning,RuntimeCapability.managed_vm_execution],default_execution_host_ref="workspace-execution-host:primary",api_scopes=["runtime:catalog","runtime:resolve","runtime:invoke","runtime:receipt"],source_product_contract_refs=["research-lab-computational-analysis","sc.core.stan-runtime.v1","sc.core.octave-runtime.v1","sc.core.gretl-hansl-runtime.v1","sc.core.haskell-runtime.v1","sc.core.fortran-runtime.v1","sc.core.c-cpp-runtime.v1","sc.core.rust-runtime.v1","sc.core.go-runtime.v1","sc.core.python-runtime.v1","sc.core.prolog-runtime.v1","sc.core.jvm-runtime.v1"],metadata={"role":"scientific-analysis-client","fortran_runtime_enabled":True,"cpp_runtime_enabled":True,"rust_runtime_enabled":True,"go_runtime_enabled":True,"python_runtime_enabled":True,"prolog_runtime_enabled":True,"jvm_runtime_enabled":True}),
        ProductRuntimeIntegrationProfile(product_profile_id="product-runtime-profile:workbench:v1",product_id=ProductId.workbench,integration_version="1.8.0",allowed_actions=[RuntimeAction.execute,RuntimeAction.interchange,RuntimeAction.inspect],allowed_runtime_refs=[REFERENCE_R_RUNTIME,REFERENCE_JULIA_RUNTIME,REFERENCE_OCTAVE_RUNTIME,REFERENCE_HASKELL_RUNTIME,REFERENCE_FORTRAN_RUNTIME,REFERENCE_CPP_RUNTIME,REFERENCE_RUST_RUNTIME,REFERENCE_GO_RUNTIME,REFERENCE_PYTHON_RUNTIME,REFERENCE_JVM_RUNTIME],allowed_operations={REFERENCE_R_RUNTIME:["descriptive_summary","correlation_matrix","linear_regression"],REFERENCE_JULIA_RUNTIME:all_julia_ops,REFERENCE_OCTAVE_RUNTIME:all_octave_ops,REFERENCE_HASKELL_RUNTIME:all_haskell_ops,REFERENCE_FORTRAN_RUNTIME:all_fortran_ops,REFERENCE_CPP_RUNTIME:all_cpp_ops,REFERENCE_RUST_RUNTIME:all_rust_ops,REFERENCE_GO_RUNTIME:all_go_ops,REFERENCE_PYTHON_RUNTIME:all_python_ops,REFERENCE_JVM_RUNTIME:all_jvm_ops},required_capabilities=[RuntimeCapability.numerical_compute,RuntimeCapability.linear_algebra,RuntimeCapability.exact_arithmetic,RuntimeCapability.scientific_hpc,RuntimeCapability.native_engineering,RuntimeCapability.safe_native_systems,RuntimeCapability.concurrent_distributed,RuntimeCapability.general_scientific,RuntimeCapability.managed_vm_execution],default_execution_host_ref="workspace-execution-host:primary",api_scopes=["runtime:catalog","runtime:resolve","runtime:invoke","runtime:receipt"],source_product_contract_refs=["workbench-computational-prototyping","sc.core.octave-runtime.v1","sc.core.haskell-runtime.v1","sc.core.fortran-runtime.v1","sc.core.c-cpp-runtime.v1","sc.core.rust-runtime.v1","sc.core.go-runtime.v1","sc.core.python-runtime.v1","sc.core.jvm-runtime.v1"],metadata={"role":"engineering-compute-client","fortran_runtime_enabled":True,"cpp_runtime_enabled":True,"rust_runtime_enabled":True,"go_runtime_enabled":True,"python_runtime_enabled":True,"jvm_runtime_enabled":True}),
    ]
