...
def reference_runtime_catalog() -> UnifiedRuntimeCatalog:
    return UnifiedRuntimeCatalog(
        ...
        generated_from_refs=["runtime-adapter-registry:platform-core","runtime-data-interchange-bundle:reference-r-julia:v1","runtime-security-governance-bundle:reference:v1","stan-runtime-bundle:reference:v1","octave-runtime-bundle:reference:v1","gretl-hansl-runtime-bundle:reference:v1","haskell-runtime-bundle:reference:v1","fortran-runtime-bundle:reference:v1","c-cpp-runtime-bundle:reference:v1","rust-runtime-bundle:reference:v1","go-runtime-bundle:reference:v1"],
...
def reference_product_profiles() -> list[ProductRuntimeIntegrationProfile]:
    ...
    return [
        ProductRuntimeIntegrationProfile(product_profile_id="product-runtime-profile:workspace:v1",product_id=ProductId.workspace,integration_version="1.8.0",allowed_actions=[RuntimeAction.execute,RuntimeAction.statistical_analysis,RuntimeAction.workflow,RuntimeAction.interchange,RuntimeAction.reproduce,RuntimeAction.verify,RuntimeAction.inspect],allowed_runtime_refs=[REFERENCE_R_RUNTIME,REFERENCE_JULIA_RUNTIME,REFERENCE_STAN_RUNTIME,REFERENCE_OCTAVE_RUNTIME,REFERENCE_GRETL_RUNTIME,REFERENCE_HASKELL_RUNTIME,REFERENCE_FORTRAN_RUNTIME,REFERENCE_CPP_RUNTIME,REFERENCE_RUST_RUNTIME,REFERENCE_GO_RUNTIME],allowed_operations={REFERENCE_R_RUNTIME:all_r_ops,REFERENCE_JULIA_RUNTIME:all_julia_ops,REFERENCE_STAN_RUNTIME:all_stan_ops,REFERENCE_OCTAVE_RUNTIME:all_octave_ops,REFERENCE_GRETL_RUNTIME:all_gretl_ops,REFERENCE_HASKELL_RUNTIME:all_haskell_ops,REFERENCE_FORTRAN_RUNTIME:all_fortran_ops,REFERENCE_CPP_RUNTIME:all_cpp_ops,REFERENCE_RUST_RUNTIME:all_rust_ops,REFERENCE_GO_RUNTIME:all_go_ops},required_capabilities=[RuntimeCapability.workflow_execution],default_execution_host_ref="workspace-execution-host:primary",api_scopes=["runtime:catalog","runtime:resolve","runtime:invoke","runtime:receipt","runtime:reproduce"],source_product_contract_refs=["workspace-runtime-orchestration","sc.core.stan-runtime.v1","sc.core.octave-runtime.v1","sc.core.gretl-hansl-runtime.v1","sc.core.haskell-runtime.v1","sc.core.fortran-runtime.v1","sc.core.c-cpp-runtime.v1","sc.core.rust-runtime.v1","sc.core.go-runtime.v1"],metadata={"role":"primary-runtime-orchestrator","rust_runtime_enabled":True,"go_runtime_enabled":True}),
        ProductRuntimeIntegrationProfile(product_profile_id="product-runtime-profile:research-lab:v1",product_id=ProductId.research_lab,integration_version="1.8.0",allowed_actions=[RuntimeAction.execute,RuntimeAction.statistical_analysis,RuntimeAction.interchange,RuntimeAction.verify,RuntimeAction.inspect],allowed_runtime_refs=[REFERENCE_R_RUNTIME,REFERENCE_JULIA_RUNTIME,REFERENCE_STAN_RUNTIME,REFERENCE_OCTAVE_RUNTIME,REFERENCE_GRETL_RUNTIME,REFERENCE_HASKELL_RUNTIME,REFERENCE_FORTRAN_RUNTIME,REFERENCE_CPP_RUNTIME,REFERENCE_RUST_RUNTIME,REFERENCE_GO_RUNTIME],allowed_operations={REFERENCE_R_RUNTIME:all_r_ops,REFERENCE_JULIA_RUNTIME:all_julia_ops,REFERENCE_STAN_RUNTIME:all_stan_ops,REFERENCE_OCTAVE_RUNTIME:all_octave_ops,REFERENCE_GRETL_RUNTIME:all_gretl_ops,REFERENCE_HASKELL_RUNTIME:all_haskell_ops,REFERENCE_FORTRAN_RUNTIME:all_fortran_ops,REFERENCE_CPP_RUNTIME:all_cpp_ops,REFERENCE_RUST_RUNTIME:all_rust_ops,REFERENCE_GO_RUNTIME:all_go_ops},required_capabilities=[RuntimeCapability.statistical_analysis,RuntimeCapability.numerical_compute,RuntimeCapability.bayesian_inference,RuntimeCapability.linear_algebra,RuntimeCapability.econometrics,RuntimeCapability.exact_arithmetic,RuntimeCapability.scientific_hpc,RuntimeCapability.native_engineering,RuntimeCapability.safe_native_systems,RuntimeCapability.concurrent_distributed],default_execution_host_ref="workspace-execution-host:primary",api_scopes=["runtime:catalog","runtime:resolve","runtime:invoke","runtime:receipt"],source_product_contract_refs=["research-lab-computational-analysis","sc.core.stan-runtime.v1","sc.core.octave-runtime.v1","sc.core.gretl-hansl-runtime.v1","sc.core.haskell-runtime.v1","sc.core.fortran-runtime.v1","sc.core.c-cpp-runtime.v1","sc.core.rust-runtime.v1","sc.core.go-runtime.v1"],metadata={"role":"scientific-analysis-client","fortran_runtime_enabled":True,"cpp_runtime_enabled":True,"rust_runtime_enabled":True,"go_runtime_enabled":True}),
        ProductRuntimeIntegrationProfile(product_profile_id="product-runtime-profile:workbench:v1",product_id=ProductId.workbench,integration_version="1.6.0",allowed_actions=[RuntimeAction.execute,RuntimeAction.interchange,RuntimeAction.inspect],allowed_runtime_refs=[REFERENCE_R_RUNTIME,REFERENCE_JULIA_RUNTIME,REFERENCE_OCTAVE_RUNTIME,REFERENCE_HASKELL_RUNTIME,REFERENCE_FORTRAN_RUNTIME,REFERENCE_CPP_RUNTIME,REFERENCE_RUST_RUNTIME,REFERENCE_GO_RUNTIME],allowed_operations={REFERENCE_R_RUNTIME:["descriptive_summary","correlation_matrix","linear_regression"],REFERENCE_JULIA_RUNTIME:all_julia_ops,REFERENCE_OCTAVE_RUNTIME:all_octave_ops,REFERENCE_HASKELL_RUNTIME:all_haskell_ops,REFERENCE_FORTRAN_RUNTIME:all_fortran_ops,REFERENCE_CPP_RUNTIME:all_cpp_ops,REFERENCE_RUST_RUNTIME:all_rust_ops,REFERENCE_GO_RUNTIME:all_go_ops},required_capabilities=[RuntimeCapability.numerical_compute,RuntimeCapability.linear_algebra,RuntimeCapability.exact_arithmetic,RuntimeCapability.scientific_hpc,RuntimeCapability.native_engineering,RuntimeCapability.safe_native_systems,RuntimeCapability.concurrent_distributed],default_execution_host_ref="workspace-execution-host:primary",api_scopes=["runtime:catalog","runtime:resolve","runtime:invoke","runtime:receipt"],source_product_contract_refs=["workbench-computational-prototyping","sc.core.octave-runtime.v1","sc.core.haskell-runtime.v1","sc.core.fortran-runtime.v1","sc.core.c-cpp-runtime.v1","sc.core.rust-runtime.v1","sc.core.go-runtime.v1"],metadata={"role":"engineering-compute-client","fortran_runtime_enabled":True,"cpp_runtime_enabled":True,"rust_runtime_enabled":True,"go_runtime_enabled":True}),
    ]
