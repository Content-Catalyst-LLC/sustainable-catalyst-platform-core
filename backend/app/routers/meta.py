...
from ..models import (
    ...
    EnsembleRecord, EnsembleMemberRecord, EnsembleStatisticRecord, UncertaintyComputeRunRecord,
    MapLayer,
    StacCollection,
    StacItem,
    LiveDataSource,
...
def meta(request: Request):
    ...
    return MetaResponse(
        ...
        capabilities=[
            ...
            "uncertainty_sensitivity_ensemble_reasoning",
            "first_class_uncertainty_definitions",
            "bounded_and_distributional_uncertainty",
            "governed_sensitivity_studies",
            "sensitivity_factor_uncertainty_bindings",
            "external_sensitivity_metric_provenance",
            "governed_ensemble_membership",
            "external_ensemble_statistics_provenance",
            "sensitivity_visualization_spec_compilation",
            "ensemble_visualization_spec_compilation",
            "monte_carlo_execution_external_to_core",
            "sensitivity_calculation_external_to_core",
...
def stats(db: Session = Depends(get_session)):
    ...
    return RegistryStats(
        ...
        sensitivity_results=count(SensitivityResultRecord),
