...
def health(request: Request):
    return {
        ...
        "interactive_renderer_view_composition": request.app.state.settings.interactive_renderer_composition_enabled,
        "analytical_visualization_grammar": request.app.state.settings.analytical_visualization_grammar_enabled,
        "linked_views_cross_filtering": request.app.state.settings.linked_views_cross_filtering_enabled,
        "visual_query_exploration_engine": request.app.state.settings.visual_query_exploration_enabled,
        "visual_model_construction": request.app.state.settings.visual_model_construction_enabled,
        "visual_predictive_intelligence": request.app.state.settings.visual_predictive_intelligence_enabled,
        "visual_forensics_workbench": request.app.state.settings.visual_forensics_workbench_enabled,
        ...
        "research_lineage_provenance_graph": request.app.state.settings.research_lineage_provenance_graph_enabled,
        ...
        "research_quality_bias_methodological_audit_engine": request.app.state.settings.research_quality_bias_methodological_audit_enabled,
        "research_workflow_orchestration_engine": request.app.state.settings.research_workflow_orchestration_enabled,
        "cross_product_research_context_handoff_protocol": request.app.state.settings.cross_product_research_context_handoff_enabled,
        "research_project_state_versioning_reproducibility": request.app.state.settings.research_project_state_versioning_reproducibility_enabled,
        "research_roles_agents_contributor_provenance": request.app.state.settings.research_roles_agents_contributor_provenance_enabled,
...
async def ready(request: Request, db: Session = Depends(get_session)):
    ...
    return {
        ...
        "interactive_renderer_view_composition": "ready" if settings.interactive_renderer_composition_enabled else "disabled",
        "analytical_visualization_grammar": "ready" if settings.analytical_visualization_grammar_enabled else "disabled",
        "linked_views_cross_filtering": "ready" if settings.linked_views_cross_filtering_enabled else "disabled",
        "visual_query_exploration_engine": "ready" if settings.visual_query_exploration_enabled else "disabled",
        "visual_model_construction": "ready" if settings.visual_model_construction_enabled else "disabled",
        "visual_predictive_intelligence": "ready" if settings.visual_predictive_intelligence_enabled else "disabled",
        "visual_forensics_workbench": "ready" if settings.visual_forensics_workbench_enabled else "disabled",
        "visual_decision_intelligence": "ready" if settings.visual_decision_intelligence_enabled else "disabled",
        "unified_visual_reasoning_engine": "ready" if settings.unified_visual_reasoning_engine_enabled else "disabled",
        "cross_product_visual_runtime_integration": "ready" if settings.cross_product_visual_runtime_integration_enabled else "disabled",
