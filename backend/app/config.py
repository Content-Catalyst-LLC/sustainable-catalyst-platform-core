...
class Settings:
    ...
    live_data_user_agent: str = "SustainableCatalystPlatformCore/2.36.1 (+https://sustainablecatalyst.com/contact/)"
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            live_data_user_agent=os.getenv(
                ...
                "SustainableCatalystPlatformCore/2.36.1 (+https://sustainablecatalyst.com/contact/)",
            ).strip(),
            ...
            uncertainty_compute_max_samples=_int("SC_CORE_UNCERTAINTY_COMPUTE_MAX_SAMPLES", 10000),
