...
class Settings:
    ...
    live_data_user_agent: str = "SustainableCatalystPlatformCore/2.63.0 (+https://sustainablecatalyst.com/contact/)"
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            live_data_user_agent=os.getenv(
                ...
                "SustainableCatalystPlatformCore/2.63.0 (+https://sustainablecatalyst.com/contact/)",
            ).strip(),
