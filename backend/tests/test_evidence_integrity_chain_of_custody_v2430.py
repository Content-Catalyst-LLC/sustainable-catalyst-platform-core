...
def app_client(tmp_path):
    app=create_app(Settings(database_url=f"sqlite:///{tmp_path/'v2430.db'}",version='2.43.0'))
...
def test_v2430_readiness_and_boundaries(tmp_path):
    ...
    r=c.get('/v1/open-forensics/readiness').json(); assert r['release']=='2.43.0' and r['migration_0046_applied'] and r['migration_0047_applied']
