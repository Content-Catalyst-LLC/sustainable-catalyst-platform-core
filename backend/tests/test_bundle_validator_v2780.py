...
def test_v2780_release_contract():
    ...
    assert (root / "schemas/research-hypothesis-competing-explanation-v1.schema.json").exists()
    assert (root / "DEPLOY_PLATFORM_CORE_V2780_CONTABO.sh").exists()
