...
def test_pristine_upgrade_to_0054(tmp_path):
    ...
    assert '0054' in applied and '0055' in applied and '0056' in applied and '0057' in applied and migration_status(db)['pending']==[] and V250_TABLES.issubset(tables(db_path))
