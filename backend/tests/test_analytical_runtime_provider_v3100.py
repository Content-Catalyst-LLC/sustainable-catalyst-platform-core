...
def test_migration_and_seeded_r_provider(tmp_path):
    ...
    assert r["release"]=="3.3.0" and r["catalyst_analytics_r_registered"] is True
    assert r["catalyst_analytics_r_version"]=="2.2.0" and r["workspace_is_execution_host"] is True
...
def test_request_result_provenance_roundtrip(tmp_path):
    ...
    env=svc.record_environment(s,{"provider_ref":"catalystanalyticsr","environment_ref":"env:r:1","runtime":"r","runtime_version":"4.x","package_manifest":{"catalystanalyticsr":"2.2.0"},"visibility":"public"})
