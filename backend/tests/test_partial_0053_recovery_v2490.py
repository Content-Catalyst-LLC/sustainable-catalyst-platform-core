...
def test_pristine_upgrade_to_0053(tmp_path):
    ...
    assert '0053' in applied and '0054' in applied and '0055' in applied and '0056' in applied and '0057' in applied and migration_status(db)['pending']==[] and V249_TABLES.issubset(tables(db_path))
