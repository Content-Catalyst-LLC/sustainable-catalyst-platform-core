...
def app_client(tmp_path):
    app=create_app(Settings(database_url=f"sqlite:///{tmp_path/'v2450.db'}",version='2.48.0'))
...
def test_v2450_readiness_boundaries_and_migration(tmp_path):
    ...
    r=c.get('/v1/open-forensics/readiness').json(); assert r['release']=='2.48.0' and r['migration_0049_applied'] is True
