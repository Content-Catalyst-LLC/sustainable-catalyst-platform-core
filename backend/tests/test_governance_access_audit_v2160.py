...
def test_governance_readiness_endpoint(client):
 r=client.get('/v1/governance/readiness'); assert r.status_code==200; body=r.json(); assert body['release']=='2.24.0'; assert body['migration_0019_applied'] is True; assert body['audit_chain']=='sha256-linked'
