...
def test_readiness_and_migration_0025():
    ...
    try:
      c=TestClient(create_app(Settings(database_url='sqlite:///'+p,observability_request_metrics_enabled=False))); b=c.get('/v1/lifecycle/readiness').json(); assert b['release']=='2.28.0' and b['migration_0025_applied'] and b['hard_delete_enabled'] is False
    finally: os.unlink(p)
