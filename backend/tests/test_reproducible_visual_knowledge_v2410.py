...
def app_client(tmp_path):
    app=create_app(Settings(database_url=f"sqlite:///{tmp_path/'v2410.db'}",version="2.50.0"))
...
def test_readiness_health_and_migration_0045(tmp_path):
    ...
    h=c.get('/health').json(); assert h['version']=='2.50.0' and h['reproducible_visual_knowledge_layer'] is True
    r=c.get('/v1/reproducible-visual-knowledge/readiness').json(); assert r['release']=='2.50.0' and r['migration_0045_applied'] is True
