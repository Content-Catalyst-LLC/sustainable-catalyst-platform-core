...
def test_readiness_and_migration_0026():
    ...
    try:
        c=TestClient(create_app(settings_for(p))); b=c.get('/v1/federation/readiness').json(); assert b['release']=='2.26.0' and b['migration_0026_applied'] and b['reference_first'] and b['trust_secrets_persisted'] is False and b['automatic_truth_promotion'] is False
    finally: os.unlink(p)
