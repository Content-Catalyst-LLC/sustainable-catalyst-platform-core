...
def test_release_and_migration_readiness():
  with tempfile.TemporaryDirectory() as td:
    c=client(td); b=c.get('/v1/workload-governance/readiness').json(); assert c.get('/health').json()['version']=='2.29.0'; assert b['release']=='2.29.0' and b['migration_0029_applied'] and b['distributed_quota_backend']=='database-shared' and b['hard_admission_control'] is True
