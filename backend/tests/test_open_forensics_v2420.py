...
def app_client(tmp_path):
    app=create_app(Settings(database_url=f"sqlite:///{tmp_path/'v2420.db'}",version="2.44.0"))
...
def test_readiness_health_and_migration_0046(tmp_path):
    ...
    r=c.get('/v1/open-forensics/readiness').json(); assert r['release']=='2.44.0' and r['migration_0046_applied'] is True
