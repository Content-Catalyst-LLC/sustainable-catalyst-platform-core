...
with tempfile.TemporaryDirectory() as td:
    ...
    ready=result_svc.readiness(s); assert ready["release"]=="3.3.0" and ready["catalyst_analytics_r_version"]=="2.2.0",ready
    ...
    provider_svc.record_environment(s,{"provider_ref":"catalystanalyticsr","environment_ref":"env:workspace-r:validation","runtime":"r","runtime_version":"4.x","package_manifest":{"catalystanalyticsr":"2.2.0"},"visibility":"public"})
    ...
    s.close()
print("PASS - Platform Core v3.3.0 Analytical Result & Provenance Integration")
