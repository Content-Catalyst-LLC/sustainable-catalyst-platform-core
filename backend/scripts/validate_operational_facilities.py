...
def main():
    ...
    assert settings.version=='2.11.0'; assert '0013' in status['applied']; assert not status['pending']
    ...
    print('PASS - Core v2.11.0 operational facility registry validation')
