...
with tempfile.TemporaryDirectory() as td:
    ...
    with database.session_factory() as db:
        ...
        visual = visual_reasoning.create_object(
            ...
            metadata={'validator':'v2.32.0'}, release='2.32.0',
        )
        spec = visualization_registry.create_specification(db, {
            ...
            'layout_constraints': {}, 'export': {}, 'metadata': {'validator':'v2.32.0'}, 'created_by':'validator',
        })
        ...
        print({
            'version':'2.32.0', 'migration_0033_applied':True, 'renderer_registry':True,
        ...
        print('PASS - Core 2.32.0 Visualization Specification & Renderer Registry validation')
