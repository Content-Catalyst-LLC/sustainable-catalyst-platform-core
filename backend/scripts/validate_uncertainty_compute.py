...
def main():
    with TemporaryDirectory() as td:
        settings=Settings(database_url=f"sqlite:///{Path(td)/'v2361.db'}",version='2.36.1.2')
        ...
        print({'version':'2.36.1.2','migration_0040_applied':True,'monte_carlo_sampling':True,'latin_hypercube_sampling':True,'sobol_index_analysis':True,'morris_analysis':True,'ensemble_aggregation':True,'probability_estimation':True,'model_execution_by_core':False,'automatic_truth_promotion':False})
        print('PASS - Core 2.36.1.2 Uncertainty Compute Runtime Integration validation')
