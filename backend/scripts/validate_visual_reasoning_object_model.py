...
with tempfile.TemporaryDirectory() as td:
    ...
    with database.session_factory() as db:
        ...
        project = research_objects.create_object(
            ...
            description="v2.31.0 visual reasoning release validator",
            entity_id=None,
            visibility="public",
        ...
        snapshot = visual_reasoning.create_snapshot(
            db, visual["id"], snapshot_key="release-v1", created_by="validator", provenance={"release": "2.31.0"}
        )
    ...
    print("PASS - Core 2.31.0 Visual Reasoning Object Model validation")
