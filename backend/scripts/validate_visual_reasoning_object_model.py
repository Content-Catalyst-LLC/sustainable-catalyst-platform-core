...
with tempfile.TemporaryDirectory() as td:
    ...
    with database.session_factory() as db:
        ...
        snapshot = visual_reasoning.create_snapshot(
            db, visual["id"], snapshot_key="release-v1", created_by="validator", provenance={"release": "2.29.0"}
        )
    ...
    print("PASS - Core 2.29.0 Visual Reasoning Object Model validation")
