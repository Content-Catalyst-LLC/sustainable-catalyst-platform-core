...
with tempfile.TemporaryDirectory() as td:
 ...
 print({'version':'2.33.0','migration_0029_applied':True,'pending_migrations':m['pending'],'distributed_quota_backend':'database-shared','decision':a.decision,'hard_admission_control':True,'automatic_scaling':False})
 print('PASS - Core 2.33.0 distributed quotas admission control and workload governance validation')
