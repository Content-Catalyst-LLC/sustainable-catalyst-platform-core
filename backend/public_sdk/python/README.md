...
# Sustainable Catalyst Public API Python Client v2.51.0
...
v2.91.0 adds `research_context_handoff_summary`, `research_context_handoff_lineage`, and `research_context_handoff_bundle`.
