...
Platform Core remains the semantic and provenance layer. Source retrieval, prose generation, citation selection, source ranking, analytical execution, layout, rendering, and automatic truth promotion remain outside Core.

### v2.38.0 Spatial & Temporal Visual Reasoning
Renderer-neutral spatial-temporal scenes with explicit Site Intelligence/Lab/Workbench execution boundaries.
