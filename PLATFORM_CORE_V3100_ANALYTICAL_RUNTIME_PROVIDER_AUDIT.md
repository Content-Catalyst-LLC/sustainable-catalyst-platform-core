...
## Acceptance
Release validation must confirm migration 0103, seeded Catalyst Analytics R 2.0.1 provider, at least 12 declared capabilities, Workspace execution ownership, Core boundary flags, API routes, SDK helpers, and WordPress status surface.
