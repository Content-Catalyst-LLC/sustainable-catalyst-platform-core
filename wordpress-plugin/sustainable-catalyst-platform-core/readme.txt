...
== 2.36.1.2 ==
Migration metadata length repair for the Uncertainty Compute Runtime Integration. Preserves the v2.36 uncertainty schema, recovers safe partial migration 0040 states, and enforces the production migration-description storage contract.
