...
// v2.74.0 Methodology & Analysis Run Registry status surface.
function sc_core_methodology_analysis_status() {
    ...
    return '<div class="sc-core-status"><strong>Methodology &amp; Analysis Run Registry</strong><br>Platform Core ' . esc_html($d['release'] ?? '2.74.0') . ' · ' . esc_html($c['methodologies'] ?? 0) . ' methods · ' . esc_html($c['runs'] ?? 0) . ' recorded runs · execution/validation external</div>';
}
