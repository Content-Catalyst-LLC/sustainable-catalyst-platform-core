...
for path in [
 'RELEASE_NOTES_V2360.md','PLATFORM_CORE_V2360_INSTALL_AND_TEST.md','PLATFORM_CORE_V2360_UNCERTAINTY_SENSITIVITY_ENSEMBLE_AUDIT.md','PLATFORM_CORE_V2360_TERMINAL_COMMANDS.txt',
 'docs/UNCERTAINTY_SENSITIVITY_ENSEMBLE_V2360.md','backend/app/services/uncertainty_reasoning.py','backend/app/routers/uncertainty_reasoning.py','backend/tests/test_uncertainty_sensitivity_ensemble_v2360.py','backend/scripts/validate_uncertainty_reasoning.py',
 'deploy_and_validate_platform_core_v2_36_0_macos.sh','PUSH_PLATFORM_CORE_V2360_FINAL.sh','DEPLOY_PLATFORM_CORE_V2360_CONTABO.sh','platform-core-v2360.env.example',
 'backend/public_sdk/downloads/sc-platform-core-public-python-v2.36.0.zip','backend/public_sdk/downloads/sc-platform-core-public-javascript-v2.36.0.zip']:
    req(path)
has('backend/app/config.py','version: str = "2.36.0"')
has('backend/app/migrations.py','("0039", "Governed uncertainty definitions')
...
for cls in ['UncertaintyDefinitionRecord','SensitivityStudyRecord','SensitivityFactorRecord','SensitivityMeasureRecord','EnsembleRecord','EnsembleMemberRecord','EnsembleStatisticRecord']:
    assert f'class {cls}(Base):' in models,cls
for name in ['uncertainty-definition-v1.schema.json','sensitivity-study-v1.schema.json','sensitivity-factor-v1.schema.json','sensitivity-measure-v1.schema.json','ensemble-v1.schema.json','ensemble-member-v1.schema.json','ensemble-statistic-v1.schema.json']:
