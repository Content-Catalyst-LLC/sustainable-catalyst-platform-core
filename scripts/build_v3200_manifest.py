...
exclude={".git",".venv","__pycache__",".pytest_cache"}; files=[]
...
(R/"BUILD_MANIFEST.json").write_text(json.dumps({"release":"3.2.0","files":files},indent=2)+"\n")
print(f"PASS - v3.2.0 manifest generated: {len(files)} files")
