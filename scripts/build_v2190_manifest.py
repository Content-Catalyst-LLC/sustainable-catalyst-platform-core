...
payload={'release':'2.19.0','file_count':len(files),'files':files}; (R/'BUILD_MANIFEST.json').write_text(json.dumps(payload,indent=2)+'\n')
print(f"PASS - v2.19.0 manifest built: {len(files)} files")
